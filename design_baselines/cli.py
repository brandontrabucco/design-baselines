...
def vary_architecture_policy(local_dir, cpus, gpus, num_parallel, num_samples):
    ...
    tune.run(vary_architecture, config={
        ...
        "forward_model_lr": 0.001,
        "solver_samples": 128,
        "solver_lr": tune.grid_search([0.0005, 0.00075, 0.001, 0.0025, 0.005, 0.0075, 0.01, 0.025]),
        "solver_steps": 200},
        num_samples=num_samples,
        local_dir=local_dir,
        resources_per_trial={'cpu': cpus // num_parallel,
...
def vary_architecture_gfp(local_dir, cpus, gpus, num_parallel, num_samples):
    ...
    tune.run(vary_architecture, config={
        ...
        "forward_model_lr": 0.001,
        "solver_samples": 128,
        "solver_lr": tune.grid_search([10.0, 25.0, 50.0, 75.0, 100.0, 250.0, 500.0, 750.0]),
        "solver_steps": 200},
        num_samples=num_samples,
        local_dir=local_dir,
        resources_per_trial={'cpu': cpus // num_parallel,
...
def vary_architecture_superconductor(local_dir, cpus, gpus, num_parallel, num_samples):
    ...
    tune.run(vary_architecture, config={
        ...
        "forward_model_lr": 0.001,
        "solver_samples": 128,
        "solver_lr": tune.grid_search([0.005, 0.002, 0.01, 0.02, 0.05, 0.1, 0.2, 0.5]),
        "solver_steps": 200},
        num_samples=num_samples,
        local_dir=local_dir,
        resources_per_trial={'cpu': cpus // num_parallel,
