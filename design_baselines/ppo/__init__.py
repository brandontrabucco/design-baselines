...
from design_baselines.ppo.trainers import Ensemble
from design_baselines.ppo.nets import ForwardModel
from design_baselines.ppo.nets import DiscreteMarginal
from design_baselines.ppo.nets import ContinuousMarginal
...
def ppo(config):
    """Optimizes for a solution to a model-based optimization problem
    using an online reinforcement learning algorithm.
